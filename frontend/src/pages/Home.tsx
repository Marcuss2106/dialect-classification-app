		...
		<div className="flex flex-col">
			<div className="relative w-screen py-64">
				...
				<div className="relative flex flex-col gap-4 z-20">
					<h1 className="text-forest text-8xl font-extrabold text-shadow-off-white text-shadow-sm/100">
						AccentMe!
					</h1>
					...
					<h3 className="text-xl">
						...
						your dialect.<br></br> Help improve speech tech for
						everyone.
					</h3>
					<div className="mt-4">
						<Link to="/speak">
			...
			<div className="relative flex flex-col items-center min-h-96 py-24">
				...
				<div className="z-10">
					<h1 className="text-7xl font-bold text-forest mb-16">
						How It Works
					</h1>
					<div className="flex justify-center px-24 items-center">
						<div className="text-2xl font-semibold">
							<ol className="flex text-left gap-16 list-decimal list-inside h-[30rem]">
			...
			<div className="relative flex flex-col text-left min-h-80 py-24 px-48 ">
				<div className="absolute inset-0 z-0 bg-[url('/students_walking.jpg')] bg-cover bg-[center_20%] bg-no-repeat" />
				<div className="absolute inset-0 bg-gradient-to-r from-soft-yellow to-transparent via-soft-yellow/100 opacity-92 z-10" />
